                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅ BOTRAX MODS_ADMIN BOT ONLINE! UID: {uid}"
...
[FFFFFF]          ⚡ BOTRAX MODS_ADMIN❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]BOTRAX MODS_ADMIN    
[FFD700]✨ Name on instagram : [FFFFFF]R3AXXY❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> BOTRAX MODS_ADMIN  ⚡"""
                            else:
                                message = f"""[C][B][FF0000]╔══════════╗
[FFFFFF]✨ folow on Instagram   
[FFFFFF]          ⚡ BOTRAX MODS_ADMIN❤️  
...
[FFD700]✨ Developer —͟͞͞ </> BOTRAX MODS_ADMIN  ⚡"""
                            ...
                            try:
                                ...
                                fallback_msg = "[FF0000]BOTRAX MODS_ADMIN BOT online! Use /help"
                        ...
                        if inPuTMsG.startswith('/stop') and is_admin(uid):
                            ...
                            stop_msg = f"[FF0000]BOTRAX MODS_ADMIN BOT stopping..."
...
async def MaiiiinE():
    ...
    os.system('clear')
    print(render('BOTRAX MODS_ADMIN', colors=['white', 'green'], align='center'))
    print('')
    print(f" - BOTRAX MODS_ADMIN BOT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" - BOTRAX MODS_ADMIN | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}") 
